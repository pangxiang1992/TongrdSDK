...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pangxiang1992/TongrdSDK.git"
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "pangxiang1992" => "2271586544@qq.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/pangxiang1992/TongrdSDK.git", :tag => "3.0.0" }
  ...
  s.preserve_paths = "TongDaoSDK.framework,TongDaoUILibrary.framework"
